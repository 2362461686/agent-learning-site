...
videos:
  - title: "RAG 从零到一：检索增强生成实战"
    ...
    platform: "bilibili"
  - title: "A Gentle Introduction to RAG"
    url: "https://www.youtube.com/watch?v=T-D1OfcDW1M"
    platform: "youtube"
  - title: "向量数据库与 RAG 架构详解"
    url: "https://www.bilibili.com/video/BV1WN4y1V7eV/"
    platform: "bilibili"
...
A: 这是经典的"检索了一个寂寞"问题。排查顺序：先看你的 chunk 大小是不是合理（500-1000 token 是个不错的起点），再看 Embedding 模型是不是太老太弱，最后检查一下文档本身质量——垃圾进垃圾出（Garbage In, Garbage Out），这个原则在 AI 时代依然有效。只是现在的"垃圾"可能是老板丢给你的那份 PDF 扫描件，全是水印还缺页，而你还得想办法让它召回出有用的东西。
